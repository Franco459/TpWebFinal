...
use ConcesionariaBundle\Entity\Reserva;
...
class ReservaController extends Controller
{
    ...
    {
        $reserva = new Reserva();
        $form = $this->createForm('ConcesionariaBundle\Form\ReservaType', $reserva);
    ...
    {
        $deleteForm = $this->createDeleteForm($reserva);
        $editForm = $this->createForm('ConcesionariaBundle\Form\ReservaType', $reserva);
